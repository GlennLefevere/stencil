...
export function createNodeSys(c: { process?: any } = {}): CompilerSystem {
  ...
  sys.lazyRequire = new NodeLazyRequire(nodeResolve, {
    '@types/jest': { minVersion: '24.9.1', recommendedVersion: '28.1.3', maxVersion: '28.0.0' },
    jest: { minVersion: '24.9.1', recommendedVersion: '28.1.3', maxVersion: '28.0.0' },
    'jest-cli': { minVersion: '24.9.0', recommendedVersion: '28.1.3', maxVersion: '28.0.0' },
